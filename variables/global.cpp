...
[[maybe_unused]] static int GLOBAL_INT = 5;

int g;              // Strongly discouraged: non-const global variable definition
// g = 5;           // Global scope → Only declarations and initializations allowed. This will result in a compilation error.
